...
function WomensProduct() {
  ...
  useEffect(() => {
    axios
      .get("http://localhost:5001/products?category=womensproducts")
  ...
  const handleAddToCartClick = (product) => {
    if (typeof handleAddToCart === "function") {
      handleAddToCart(product, 1); // add 1 piece to cart
  ...
  return (
    <div className="bg-gray-50 pb-10 pt-2 min-h-screen">
      <div className="max-w-7xl mx-auto">
        ...
        <h3 className="text-lg font-semibold mb-2 pl-2">All Women's Products</h3>
