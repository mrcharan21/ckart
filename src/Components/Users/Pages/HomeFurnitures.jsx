...
function HomeFurnitures() {
  ...
  useEffect(() => {
    axios
      .get("http://localhost:5001/products?category=homeFurniture")
      .then((res) => setProducts(res.data))
      .catch((err) => console.error("Failed to fetch home furniture products:", err));
  }, []);
  ...
  return (
    <div className="bg-gray-50 pb-10 pt-2 min-h-screen">
      <div className="max-w-7xl mx-auto">
            ...
            products.slice(0, 5).map((product) => (
              ...
              >
                ...
                <div className="mt-2">
                  ...
                  <button
                    className="bg-pink-700 hover:bg-pink-800 text-white px-3 py-1 rounded text-sm"
        ...
        <h3 className="text-lg font-semibold mb-2 pl-2">All Home Furnitures</h3>
