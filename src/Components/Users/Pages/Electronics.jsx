...
function Electronics() {
  ...
  useEffect(() => {
    axios
      .get("http://localhost:5001/products?category=electronics")
      .then((res) => setProducts(res.data))
      .catch((err) => console.error("Failed to fetch electronics products:", err));
  }, []);
  ...
  return (
    <div className="bg-gray-50 pb-10 pt-2 min-h-screen">
      <div className="max-w-7xl mx-auto">
        ...
        <h3 className="text-lg font-semibold mb-2 pl-2">All Electronics Products</h3>
